...
///
    ...
    private:
        ...
        static Scalar
        quadratic_interp(const Scalar &a, const Scalar &b, const Scalar &fa, const Scalar &ga, const Scalar &fb) {
          const Scalar ba = b - a;
        ...
        // Assume that a != b
        static Scalar
        cubic_interp(const Scalar &a, const Scalar &b, const Scalar &fa, const Scalar &fb, const Scalar &ga,
                     const Scalar &gb) {
          using std::abs;
          using std::sqrt;
    ...
    public:
        ...
        static void LineSearch(Foo &f, Scalar &fx, Vector &x, Vector &grad,
           ...
           std::printf("========================= Entering line search with startstep %.4f =========================\n",
                       step);
          ...
          for (iter = 0; iter < param.max_linesearch; iter++) {
            ...
            std::printf("linesearch with step %.4f gives Loss: %.4f\n", step, fx);
