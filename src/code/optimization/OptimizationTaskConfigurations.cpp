...
Simulation::FabricConfiguration OptimizationTaskConfigurations::sphereFabric = {.clothDimX = 4.5,
    .clothDimY = 4.5,
...
Simulation::FabricConfiguration OptimizationTaskConfigurations::slopeFabricRestOnPlane = {.clothDimX = 4.5,
    .clothDimY = 4.5,
...
Simulation::SceneConfiguration OptimizationTaskConfigurations::hatScene = {.fabric = agenthat579,
...
Simulation::SceneConfiguration OptimizationTaskConfigurations::rotatingSphereScene = {.fabric = sphereFabric,
...
Simulation::SceneConfiguration OptimizationTaskConfigurations::windScene = {.fabric = normalFabric6,
    .orientation = Orientation::FRONT,
...
Simulation::SceneConfiguration OptimizationTaskConfigurations::tshirtScene = {.fabric = tshirt1000,
...
Simulation::TaskConfiguration OptimizationTaskConfigurations::demoWInd = {.scene = windScene,
    .hasGroundtruth = true,
    .generateGroundtruthSimulation = true,
    .lossType = LossType::MATCH_TRAJECTORY};

Simulation::TaskConfiguration OptimizationTaskConfigurations::demoTshirt = {.scene = tshirtScene,
    .hasGroundtruth = true,
    .generateGroundtruthSimulation = true,
    .lossType = LossType::MATCH_TRAJECTORY};

Simulation::TaskConfiguration OptimizationTaskConfigurations::demoSphere = {.scene = rotatingSphereScene,
    .hasGroundtruth = true,
    .generateGroundtruthSimulation = true,
    .lossType = LossType::MATCH_TRAJECTORY};

Simulation::TaskConfiguration OptimizationTaskConfigurations::demoHat = {.scene = hatScene,
    .hasGroundtruth = false,
    .generateGroundtruthSimulation = false,
    .lossType = LossType::MATCHSHAPE_WITH_TRANSLATION};

Simulation::TaskConfiguration OptimizationTaskConfigurations::demoSock = {.scene = sockScene,
    .hasGroundtruth = false,
    .generateGroundtruthSimulation = false,
    .lossType = LossType::ASSISTED_DRESSING_KEYPOINTS};

Simulation::TaskConfiguration OptimizationTaskConfigurations::demoSlope = {.scene = slopeSimplifiedScene,
    .hasGroundtruth = true,
    .generateGroundtruthSimulation = true,
    .lossType = LossType::MATCHSHAPE_WITH_TRANSLATION};

Simulation::TaskConfiguration OptimizationTaskConfigurations::demoDress = {.scene = dressScene,
    .hasGroundtruth = false,
    .generateGroundtruthSimulation = false,
...
std::vector<Simulation::SceneConfiguration> OptimizationTaskConfigurations::sceneConfigArrays = {
    windScene, continousNormalScene, rotatingSphereScene, hatScene, sockScene, tshirtScene, dressScene};
