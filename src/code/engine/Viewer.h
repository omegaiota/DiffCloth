...
public:
  ...
  nanogui::Button *forwardStartSimulationButton = nullptr, *playbackSimulationButton = nullptr,
                  *forwardStopSimulationButton = nullptr, *backwardPlayGroundtruthSimulationButton = nullptr,
                  *backwardPlayRecordButton = nullptr;
  nanogui::TextBox *simulationInfoTextBox = nullptr, *infoTextBox = nullptr, *backwardInfo1 = nullptr,
                   *backwardInfo2 = nullptr;
  ...
  nanogui::ref<nanogui::Window> mainConfigWindow, forwardSimControlWindow, reinitWindow, backwardSimControlWindow,
      backwardSimInfoWindow, forwardInfoWindow, backwardSimFiniteDiffInfoWindow, particleInfoWindow;
  ...
  bool isSimulationOn = false, isplaybackSimulationOn = false, isforward = true, backwardNeedsInitiation = false,
       backwardRunning = false, playGroundtruth = false, playLineSearch = false, renderWithGroundTruth = false;
  ...
  std::vector<std::string> renderModeStrings = std::vector<std::string>{"FABRIC_COLOR", "SOLID_CUSTOM", "WIREFRAME",
      "WIREFRAME_COLORED", "SOLID-2SIDES", "DEFORMATION", "NORMAL_MAP", "RANDOM_COLOR"};
  enum RenderMode {
    FABRIC_COLOR,
    SOLID_CUSTOM,
    WIREFRAME,
  ...
  void gradientInfoWindowContentUpdate(
      BackwardGradientInfoWidgets &gradientWidgets, Simulation::BackwardInformation &gradient, bool isFiniteDiff);

  void forwardInfoWindowContentUpdate(ForwardInfoWidgets &forwardWidgets, Simulation::ForwardInformation &forwardInfo);
