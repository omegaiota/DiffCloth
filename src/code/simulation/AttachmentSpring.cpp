...
Vec3d AttachmentSpring::dforce_dk(const VecXd &x_vec) const { return -(p1_vec3(x_vec) - fixedPointPos()); }
...
Mat3x3d AttachmentSpring::getStretchingHessian(const VecXd &x_vec) const { return Mat3x3d::Identity() * k_stiff; }
