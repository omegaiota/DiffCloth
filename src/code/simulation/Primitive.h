...
public:
  ...
  Primitive(PrimitiveType t, const Vec3d &c, bool isCollection, Vec3d color)
      : mu(0), type(t), center(c), centerInit(c), mass(30), velocity(0, 0, 0),
        velocityInit(0, 0, 0), isEnabled(false), gravityEnabled(false),
        isStaitc(true), simulationEnabled(true),
        isPrimitiveCollection(isCollection), color(color) {}
